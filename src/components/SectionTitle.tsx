...
export default function SectionTitle({ title, index }: { title: string; index: number }) {
    return (
        <div className="flex items-center gap-6 max-[1200px]:gap-4 max-[1024px]:gap-3 max-[800px]:gap-2 select-none">
            <p className={`${readexPro.className} text-[#FFFFFF] font-semibold flex items-center text-[36px] leading-[44px] max-[1200px]:text-[28px] max-[1200px]:leading-[36px] max-[1024px]:text-[24px] max-[1024px]:leading-[32px] max-[800px]:text-[20px] max-[800px]:leading-[28px] gap-3 max-[1200px]:gap-2 max-[800px]:gap-1`}>
