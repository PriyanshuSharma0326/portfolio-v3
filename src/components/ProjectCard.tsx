...
export default function ProjectCard({ item }: ProjectCardProps) {
    ...
    return (
        <LeftToPositionWrapper duration={0.5} className="w-full relative">
            ...
            <div className={`${readexPro.className} max-[800px]:p-6 w-[50%] max-[1024px]:w-3/5 max-[800px]:w-full text-right max-[800px]:text-left absolute h-full bg-transparent right-0 top-0 flex flex-col gap-4 justify-center`}>
                <h1
                    className="cursor-pointer w-fit ml-auto max-[800px]:ml-0 text-[24px] leading-[36px] max-[1200px]:text-[22px] max-[1200px]:leading-[32px] max-[600px]:text-[20px] max-[800px]:leading-7 tracking-tight font-bold relative inline-block 
                ...
                <div className="p-6 max-[800px]:p-0 w-full h-fit bg-darkBlue1 max-[800px]:bg-transparent rounded-md tracking-normal text-[14px] leading-6 max-[800px]:text-[12px] max-[800px]:leading-[18px] font-normal shadow-[-2px_0px_22px_0px_#23205487]">
                    <p className="text-gray2">{item.description[language as 'en' | 'es']}</p>
                </div>

                <div className="w-[90%] max-[800px]:w-full ml-auto max-[800px]:ml-0 justify-end max-[800px]:justify-start flex flex-wrap gap-3 max-[1200px]:gap-2 text-gray1">
