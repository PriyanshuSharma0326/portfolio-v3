import { IconProps } from "@/app/_lib/types";
...
const MenuIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={28} height={28} color={"#45FFCA"} fill={"none"} {...props}>
...
const CrossIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={36} height={36} color={"#45FFCA"} fill={"none"} {...props}>
...
const GithubIcon: React.FC<IconProps> = ({ size = 22, ...props }) => {
    return (
...
const LinkSquareIcon: React.FC<IconProps> = ({ size = 22, ...props }) => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={size} height={size} color={"#FFFFFCCE"} fill={"none"} {...props}>
